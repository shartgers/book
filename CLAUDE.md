...
**Chapter 01 — complete.** All six tasks done; `ch01-final.md` written.

**Next task when ready:** Wave 1 for Chapter 02 — Leadership Is Not Optional (Planner + Research Agent in parallel).
