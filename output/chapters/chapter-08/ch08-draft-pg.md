...
Three structural errors recur. Organisations optimise for one dimension only, usually value, and ignore capability readiness and governance risk. A high-value use case that the organisation lacks the talent, data, or process maturity to deliver is not a high-value investment. It is a high-risk one. Organisations also fail to establish performance baselines before implementing AI. Without a baseline, there is no way to measure whether an initiative created value or simply created activity. Traditional ROI models fail for AI because the systems evolve with data and integration depth. As Chapter 1 established, this is a transformation, not a deployment. Investments measured on six-month windows will almost always disappoint. Multi-year tracking is the minimum credible measurement standard.
...
## Handoff — Perplexity Gate — Chapter 08
Status: complete
Output: output/chapters/chapter-08/ch08-draft-pg.md
Phrases rewritten: 8
Categories flagged: 1 (AI filler), 2 (generic business), 3 (predictable structures), 4 (em dashes)
