...
The required mental model is fundamentally different. This is 80% business transformation and 20% technology transformation. That framing, articulated by McKinsey's North America Chair Eric Kutcher, is a structural claim about where value is created and where it is lost, not a rhetorical device.
...
## Handoff — Perplexity Gate — Chapter 02
Status: complete
Output: output/chapters/chapter-02/ch02-draft-pg.md
Phrases rewritten: 14
Categories flagged: Category 2 (generic business language), Category 3 (predictable sentence structures), Category 5 (long paragraphs per brand voice)
