...
McKinsey, in its landmark September 2025 analysis of agentic AI, described this moment as "the largest organizational paradigm shift since the industrial and digital revolutions". That framing is not consulting hyperbole. It is an analytical claim with precise implications.
...
The 10/20/70 rule makes the structural issue plain. Algorithms account for 10% of what is required to generate real AI value. The technology backbone is another 20%. The remaining 70% is people and processes: the organisational decisions about how work is designed, how authority is allocated, how humans and AI agents collaborate, and how the organisation learns from its deployments. Most companies invest heavily in the 10% and treat the 70% as a downstream consequence. It is not. It is the primary variable.
...
The organisations that will define their industries over the next decade are making irreversible commitments now, not waiting for certainty that will never arrive. For European leaders specifically, the window carries a dual character: the competitive pressure to act, and the regulatory infrastructure that, properly understood, provides a foundation for trusted AI at scale. Both clocks are running. Neither pauses for deliberation.
...
1. What would have to be true for your organisation to be in the five per cent achieving AI value at scale, and how much of it is true today?
...
3. Ninety per cent of transformative AI use cases are stuck in pilot mode. How many of yours are? What is actually preventing them from scaling?
...
Word count (your sections): ~3,020
