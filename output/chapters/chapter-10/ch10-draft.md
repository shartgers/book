...
## Nine Lessons from Europe's AI Leaders
...
### Lesson 3: Build a central AI engine, then embed expertise where value is created
...
### Lesson 6: The hybrid human-AI model is the endgame
...
Chapter 9 made the case for Europe's distinctive edge. This lesson shows what the leaders did with it.
...
The lesson is straightforward: if AI savings flow only to the P&L and not back to employees, adoption stalls and trust erodes. The companies that invested in people alongside AI avoided the correction Klarna had to make publicly.
...
## What the Nine Lessons Mean for the Board
...
## Handoff — Writer — Chapter 10
Status: complete
Output: output/chapters/chapter-10/ch10-draft.md
Word count (your sections): ~3,960
Conditions failed: none
Footnotes log: (none this chapter)
Next agent: Perplexity Gate (Wave 3) only
