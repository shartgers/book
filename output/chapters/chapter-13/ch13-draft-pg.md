...
- **Deliberate withholding.** Maintaining a control group means some customers do not receive the AI-enhanced experience whilst the measurement window is open. This creates a short-term quality asymmetry that requires careful governance and a clear endpoint.
...
## Handoff — Perplexity Gate — Chapter 13
Status: complete
Output: output/chapters/chapter-13/ch13-draft-pg.md
Phrases rewritten: 9
Categories flagged: Category 1 (leveraged), Category 3 (mechanical First/Second/Third list), Category 4 (em dashes in case study body ×3, case study heading ×1), Category 5 (while → whilst)
