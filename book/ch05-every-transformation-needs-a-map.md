...
**Layer 3: Operating Model.** This is where strategy becomes structure. It has two dimensions. _People:_ roles, target skills and gaps, org sizing, talent journey, training, and team incentives. The agentic employee (Chapter 3) sits here: orchestrating agents, with the three profiles of supervisor, specialist, and augmented frontline worker. _Process:_ org design, cross-functional teams, and product way-of-working. Transformation demands end-to-end workflow redesign around human–agent collaboration. Chapter 6 dives deeper into this layer.
