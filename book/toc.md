...
Writers: when you mention "the framework" or "the AI Transformation Framework," use this four-layer structure. Reference the image where it helps the reader (e.g. in Ch 4 and Ch 10).
...
|---------|-----------|-----------------|-----------|
| 1: The Largest Shift Since the Industrial Revolution | 9% | ~4,050 | Sets the stage with the scale of change, the 95% failure rate, and urgency. Why this moment is different and why the window for first-mover advantage is narrowing. Tight and persuasive to hook the CEO reader. |
| 2: When Sponsorship Is Not Enough | 8% | ~3,600 | Makes the case for CEO-/board-led transformation. Why transformation fails when delegated: the roles of CEO, C-suite, and board; shared accountability and stakes for leadership. |
| 3: What the Agentic Organisation Looks Like | 8% | ~3,600 | Builds the core vision. Defines the Agentic Organisation, the agentic employee, and three key roles. Mindset shift from task-doer to orchestrator; foundational concepts only—the framework comes in Ch 5. |
| 4: When Local Wins Don't Add Up | 9% | ~4,050 | Individual → Team → Department → Organisation. Connects Tiers to the framework; how capability accumulates (or fails to) and what leaders must do at each tier. What transformation compounding looks like; "how to achieve it" follows in later chapters. |
| 5: Every Transformation Needs a Map | 6% | ~2,700 | Introduces the four-layer AI Transformation Framework and supporting image. Briefly covers each layer; orients the reader for the book’s structure. Covers Vision, Products; other layers are deep-dived in later chapters. |
| 6: The Vision Layer | 6% | ~2,700 | Deep dive on Layer 1 (Vision, strategy, values, objectives) of the AI Transformation Framework. How CEOs define, communicate, and govern AI vision; translating vision into strategic objectives and values that hold under pressure. Named framework: The Vision Layer Blueprint. |
...
| 14: Readiness | 4% | ~1,800 | Readiness diagnostics and tools for assessment. Where the organisation is, what to fix first, and how to prioritise before scaling. |
| 15: Measuring What Matters | 6% | ~2,700 | Governance, KPIs, measurement, financials, and board accountability. How CEOs can see and drive real progress and avoid “pilot purgatory.” Not a framework layer. |
| 16: A Leadership Decision | 6% | ~2,700 | Conclusion and call to action. Sums up, re-anchors to the CEO, and pushes for decisive leadership. The cost of waiting; who is building the Agentic Organisation today. |
...
Deep dive on Layer 1 of the AI Transformation Framework. How CEOs define and govern AI vision; translating vision into strategic objectives and values that hold under pressure. Named framework: The Vision Layer Blueprint.
